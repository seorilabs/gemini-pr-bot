...
# optional AI review providers. MiniMax is the default provider and is
# required; Copilot and Cursor keys are optional fallbacks.
#
# Usage:
...
if [[ -n "${CURSOR_API_KEY}" ]]; then
  args+=(--from-literal=CURSOR_API_KEY="${CURSOR_API_KEY}")
fi
